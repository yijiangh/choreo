...
#include <ui_output_path_input_config.h>

framefab_gui::OutputPathInputConfigWidget::OutputPathInputConfigWidget(framefab_msgs::OutputPathInputParameters params)
    : params_(params)
{
  ui_ = new Ui::OutputPathInputConfigWindow();
  ui_->setupUi(this);
  ...
  connect(ui_->pushbutton_output_path, SIGNAL(clicked()), this, SLOT(get_file_path_handler()));
