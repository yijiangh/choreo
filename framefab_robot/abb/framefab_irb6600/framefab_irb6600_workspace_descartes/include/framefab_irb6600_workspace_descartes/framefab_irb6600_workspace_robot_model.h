...
#ifndef FRAMEFAB_IRB6600_WORKSPACE_ROBOT_MODEL_H
#define FRAMEFAB_IRB6600_WORKSPACE_ROBOT_MODEL_H

#include <descartes_moveit/moveit_state_adapter.h>
//#include <framefab_irb6600_workspace_ikfast_manipulator_plugin/framefab_irb6600_workspace_manipulator_ikfast_moveit_plugin.hpp>

namespace framefab_irb6600_workspace_descartes
{
class FramefabIrb6600WorkspaceRobotModel : public descartes_moveit::MoveitStateAdapter
//                             public ikfast_kinematics_plugin::IKFastKinematicsPlugin
{
public:
  FramefabIrb6600WorkspaceRobotModel();
  ...
  {
    descartes_core::RobotModelPtr ptr(new FramefabIrb6600WorkspaceRobotModel());
