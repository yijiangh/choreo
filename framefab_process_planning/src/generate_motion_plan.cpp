...
static framefab_process_planning::DescartesTraj generateUnitProcessMotionPlan(const descartes_core::RobotModelPtr model,
                        const framefab_process_planning::DescartesUnitProcess traj,
