...
framefab_process_planning::PoseVector
framefab_process_planning::interpolateCartesian(const Eigen::Affine3d& start,
                                             const Eigen::Affine3d& stop, double ds)
{
  ...
  framefab_process_planning::PoseVector result;
...
framefab_process_planning::JointVector
framefab_process_planning::interpolateJoint(const std::vector<double>& start,
                                         const std::vector<double>& stop, double dtheta)
{
  framefab_process_planning::JointVector result;
  // joint delta
