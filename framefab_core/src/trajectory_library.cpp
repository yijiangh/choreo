...
void framefab_core_service::TrajectoryLibrary::save(const std::string& filename)
{
  rosbag::Bag bag;
...
void framefab_core_service::TrajectoryLibrary::load(const std::string& filename)
{
  rosbag::Bag bag;
