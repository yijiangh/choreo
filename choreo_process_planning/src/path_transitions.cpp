...
toDescartesConstrainedPath(const std::vector <choreo_msgs::ElementCandidatePoses> &task_sequence,
                           const ConstrainedSegParameters &seg_params)
{
  ...
  auto add_segment = [seg_params]
      (ConstrainedSegment &seg, const choreo_msgs::ElementCandidatePoses path_pose)
  {
