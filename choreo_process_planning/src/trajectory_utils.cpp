...
choreo_process_planning::PoseVector
choreo_process_planning::interpolateCartesian(const Eigen::Affine3d& start,
                                             const Eigen::Affine3d& stop, double ds)
{
  ...
  choreo_process_planning::PoseVector result;
...
choreo_process_planning::JointVector
choreo_process_planning::interpolateJoint(const std::vector<double>& start,
                                         const std::vector<double>& stop, double dtheta)
{
  choreo_process_planning::JointVector result;
  // joint delta
