...
#ifndef CHOREO_PROCESS_PLANNING_PATH_TRANSITIONS_H
#define CHOREO_PROCESS_PLANNING_PATH_TRANSITIONS_H
...
std::vector<descartes_planner::ConstrainedSegmentPickNPlace> toDescartesConstrainedPath(
    const choreo_msgs::AssemblySequencePickNPlace& task_sequence,
...
std::vector<descartes_planner::ConstrainedSegment> toDescartesConstrainedPath(
    const std::vector<choreo_msgs::ElementCandidatePoses>& task_sequence,
...
#endif //CHOREO_PROCESS_PLANNING_PATH_TRANSITIONS_H