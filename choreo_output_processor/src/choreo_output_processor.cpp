...
{
  // ref choreo_msgs/SubProcess.msg process_type table
...
{
  // ref choreo_msgs/SubProcess.msg main_data_type_type table
...
{
  // ref choreo_msgs/SubProcess.msg element_process_type table
...
bool choreo_output_processor::OutputProcessor::outputJson(std::vector<choreo_msgs::UnitProcessPlan>& plans)
{
