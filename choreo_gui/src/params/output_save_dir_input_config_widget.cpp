...
void choreo_gui::OutputSaveDirInputConfigWidget::update_display_fields()
{
  checkFileExtension(params_.file_path);
  ui_->lineedit_filepath->setText(QString(params_.file_path.c_str()));
}

void choreo_gui::OutputSaveDirInputConfigWidget::update_internal_fields()
{
...
void choreo_gui::OutputSaveDirInputConfigWidget::get_file_path_handler()
{
