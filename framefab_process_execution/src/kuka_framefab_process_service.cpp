...
//
#include <framefab_process_execution/kuka_blend_process_service.h>
...
//#include "kuka_file_suite/ExecuteProgram.h"
...
const static std::string THIS_SERVICE_NAME = "framefab_process_execution";
...
framefab_process_execution::KukaFrameFabProcessService::KukaFrameFabProcessService(ros::NodeHandle& nh) : nh_(nh),
  process_exe_action_server_(nh_,
                             PROCESS_EXE_ACTION_SERVER_NAME,
                             boost::bind(
                                 &framefab_process_execution::KukaFrameFabProcessService::executionCallback,
                                 this, _1),
                             false)
{
...
void framefab_process_execution::KukaFrameFabProcessService::executionCallback(
...
bool framefab_process_execution::KukaFrameFabProcessService::executeProcess(
    const framefab_msgs::ProcessExecutionGoalConstPtr &goal)
{
...
bool framefab_process_execution::KukaFrameFabProcessService::simulateProcess(
    const framefab_msgs::ProcessExecutionGoalConstPtr &goal)
{
