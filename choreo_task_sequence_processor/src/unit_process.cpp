...
void choreo_task_sequence_processing_utils::UnitProcess::createShrinkedEndPoint(Eigen::Vector3d& st_pt, Eigen::Vector3d& end_pt,
...
{
  choreo_msgs::ElementCandidatePoses msg;
  ...
  if("support" == type_)
  {
    msg.type = choreo_msgs::ElementCandidatePoses::SUPPORT;
  }
  if("create" == type_)
  {
    msg.type = choreo_msgs::ElementCandidatePoses::CREATE;
  }
  if("connect" == type_)
  {
    msg.type = choreo_msgs::ElementCandidatePoses::CONNECT;
  }
