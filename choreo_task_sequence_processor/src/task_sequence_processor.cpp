...
void scalePoseFramefabMsg(const double& scale, choreo_msgs::Grasp& g)
{
    ...
    choreo_msgs::AssemblySequencePickNPlace& as_pnp)
{
  ...
  {
    choreo_msgs::SequencedElement se_msg;
...
choreo_task_sequence_processing_utils::UnitProcess
choreo_task_sequence_processing::TaskSequenceProcessor::createScaledUnitProcess(
...
{
  choreo_task_sequence_processing_utils::UnitProcess upp(
      index, wireframe_id,
